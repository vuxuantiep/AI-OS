...
const UEBERSETZUNGEN = {
  ...
  de: {
    ...
    "footer": "DocuCheck Local v0.2 · Technik: WebLLM 0.2.79 (MLC AI, Apache 2.0) + WebGPU · Tesseract.js 5.1.1 (OCR) + pdf.js 4.4.168 — alle Bibliotheken lokal gebündelt, keine CDN-Zugriffe. Teil der Edge Cognitive AI Platform.",
  ...
  en: {
    ...
    "footer": "DocuCheck Local v0.2 · Tech: WebLLM 0.2.79 (MLC AI, Apache 2.0) + WebGPU · Tesseract.js 5.1.1 (OCR) + pdf.js 4.4.168 — all libraries bundled locally, no CDN calls. Part of the Edge Cognitive AI Platform.",
  ...
  vi: {
    ...
    "footer": "DocuCheck Local v0.2 · Công nghệ: WebLLM 0.2.79 (MLC AI, Apache 2.0) + WebGPU · Tesseract.js 5.1.1 (OCR) + pdf.js 4.4.168 — mọi thư viện được đóng gói cục bộ, không gọi CDN. Thuộc Edge Cognitive AI Platform.",
