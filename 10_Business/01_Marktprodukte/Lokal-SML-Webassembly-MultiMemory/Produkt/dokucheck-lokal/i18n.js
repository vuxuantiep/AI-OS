/* DocuCheck Local — Mehrsprachigkeit (Deutsch / English / Tiếng Việt).
...
const UEBERSETZUNGEN = {
  /* ================= DEUTSCH ================= */
  de: {
    "html.title": "DocuCheck Local — KI-Dokumentanalyse ohne Cloud",
    ...
    "s1.presetLabel": "Profil:",
    "s1.p1": "Schnell & leicht (1B)",
    "s1.p2": "Standard (1B)",
    "s1.p3": "Präzise & gründlich (3B)",
    "s1.p4": "Experimental (Phi-3.5-mini)",
    "s1.m0": "Qwen2 0.5B — sehr leicht, für schwache Geräte (~0,5 GB)",
    ...
    "s1.m4": "Phi 3.5 mini — experimentell, gründlich (~2,2 GB)",
    ...
    "s1.autoLoad": "Modell ist schon auf dem Gerät — wird automatisch geladen …",
    "s1.ready": "Modell bereit — ab jetzt zählt der Netzwerk-Beweis.",
    "s1.error": "Fehler beim Laden:",
    "s1.needModel": "Bitte zunächst das Modell in Schritt 1 vollständig laden.",
    "s1.needModelTitle": "Modell fehlt",
    "s1.offline": "Seite neu laden und erneut versuchen. Falls das Problem weiter besteht, verwenden Sie einen aktuellen Desktop-Browser mit WebGPU-Unterstützung.",
    "s1.ocrHint": "Texterkennung (OCR) läuft trotzdem lokal — ohne WebGPU.",

    "s2.tag": "Schritt 2",
    "s2.title": "Dokument auswählen",
    "s2.ready": "Dokument bereit",
    "s2.needDoc": "Bitte zuerst ein Dokument in Schritt 2 auswählen und einlesen.",
    "s2.needDocTitle": "Dokument fehlt",
    "s2.error": "Die Datei konnte nicht verarbeitet werden. Bitte ein klar lesbares Dokument oder ein PDF mit Text wählen.",
    "s2.ocrBad": "Die Texterkennung war unvollständig. Bitte ein klareres Foto oder einen Scan mit höherer Auflösung verwenden.",
    "s2.fileTooBig": "Die Datei ist zu groß. Bitte ein kleineres Dokument verwenden.",
    ...
    "ocr.badQuality": "Die Texterkennung war unvollständig. Bitte ein klareres Foto oder einen Scan mit höherer Auflösung verwenden.",
    "ocr.workerFailed": "Tesseract-Worker abgestürzt. Bitte Seite neu laden.",
    "file.reading": "Lese:",
    "file.error": "Fehler beim Lesen:",
    "file.tooBig": "Die Datei ist zu groß. Bitte ein kleineres Dokument verwenden.",
    "file.chars": "Zeichen",
    ...
    "s3.presetLabel": "Prüfung:",
    "s3.presetNone": "-- auswählen --",
    "s3.p1": "Vollprüfung (Vertrag)",
    "s3.p2": "Mietvertrag (privat)",
    "s3.p3": "Mobilfunkvertrag",
    "s3.p4": "Versicherungsbedingungen",
    "s3.presetRun": "Starten",
    ...
    "disclaimer": "Hinweis: DocuCheck Local gibt dir eine erste Einschätzung durch eine kleine KI — das ist keine Rechtsberatung. Bei wichtigen Verträgen und Fristen frag bitte eine Anwältin, einen Anwalt oder eine Beratungsstelle. Kleine Modelle können Fehler machen — prüfe wichtige Aussagen immer im Originaltext.",
    "err.prefix": "Fehler:",
    "err.webgpu": "WebGPU wird nicht unterstützt. Bitte Seite neu laden und einen aktuellen Chrome/Edge-Browser verwenden.",
    "err.tesseract": "Texterkennung (Tesseract) konnte nicht gestartet werden. Bitte Seite neu laden.",
    "err.memory": "Nicht genügend Speicher. Bitte ein kleineres Dokument wählen oder andere Tabs schließen.",
    "err.reload": "Bitte Seite neu laden und erneut versuchen. Falls das Problem weiter besteht, verwenden Sie einen aktuellen Desktop-Browser mit WebGPU-Unterstützung.",
    "safety.localOnly": "Alle Verarbeitung läuft lokal — keine Daten verlassen dein Gerät.",
    "safety.devtools": "Prüfe es selbst: Öffne die Entwicklertools (F12 → Netzwerk) während der Analyse.",
    ...
    "note.transCut": "(Hinweis: Sehr langes Dokument — die ersten {n} Zeichen wurden übersetzt.)",
    "trans.same": "Das Dokument scheint bereits auf {ziel} zu sein — nichts zu übersetzen.",
    "trans.loading": "Übersetzungsmodell wird geladen (einmalig, danach offline nutzbar) …",
    "trans.running": "Übersetze Abschnitt {i}/{n} …",

    "step.ready": "✓ bereit",
    "hint.needModel": "Dokument ist bereit ✓ — Übersetzen geht sofort. Für Zusammenfassung & Analyse lade noch das KI-Modell in Schritt 1.",
    ...
    "footer": "DocuCheck Local v0.3 · Technik: WebLLM 0.2.79 (MLC AI, Apache 2.0) + WebGPU · transformers.js 3.8.1 + OPUS-MT (Übersetzung, CPU) · Tesseract.js 5.1.1 (OCR) + pdf.js 4.4.168 — alle Bibliotheken lokal gebündelt, keine CDN-Zugriffe. Teil der Edge Cognitive AI Platform.",
  ...
  /* ================= ENGLISH ================= */
  en: {
    "html.title": "DocuCheck Local — AI document analysis without the cloud",
    ...
    "s1.modelLabel": "Model:",
    "s1.presetLabel": "Profile:",
    "s1.p1": "Fast & lightweight (1B)",
    "s1.p2": "Standard (1B)",
    "s1.p3": "Precise & thorough (3B)",
    "s1.p4": "Experimental (Phi-3.5-mini)",
    "s1.m0": "Qwen2 0.5B — very light, for weak devices (~0.5 GB)",
    ...
    "s1.m4": "Phi 3.5 mini — experimental, thorough (~2.2 GB)",
    ...
    "s1.autoLoad": "Model already on your device — loading automatically …",
    "s1.ready": "Model ready — the network proof counter is now armed.",
    "s1.error": "Loading failed:",
    "s1.needModel": "Please fully load the model in step 1 first.",
    "s1.needModelTitle": "Model missing",
    "s1.offline": "Please reload the page and try again. If the issue persists, use a current desktop browser with WebGPU support.",
    "s1.ocrHint": "OCR still works locally without WebGPU.",

    "s2.tag": "Step 2",
    "s2.title": "Pick a document",
    "s2.ready": "Document ready",
    "s2.needDoc": "Please select and load a document in step 2 first.",
    "s2.needDocTitle": "Document missing",
    "s2.error": "Could not process the file. Please choose a clearly readable document or a PDF with text.",
    "s2.ocrBad": "Text recognition was incomplete. Please use a clearer photo or a higher-resolution scan.",
    "s2.fileTooBig": "The file is too large. Please choose a smaller document.",
    ...
    "ocr.error": "OCR error:",
    "ocr.badQuality": "Text recognition was incomplete. Please use a clearer photo or a higher-resolution scan.",
    "ocr.workerFailed": "Tesseract worker crashed. Please reload the page.",
    "file.reading": "Reading:",
    "file.error": "Could not read the file:",
    "file.tooBig": "The file is too large. Please choose a smaller document.",
    ...
    "s3.presetLabel": "Check:",
    "s3.presetNone": "-- select --",
    "s3.p1": "Full contract review",
    "s3.p2": "Rental agreement (private)",
    "s3.p3": "Mobile contract",
    "s3.p4": "Insurance terms",
    "s3.presetRun": "Start",
    "btn.sum": "Summarize",
    ...
    "disclaimer": "Note: DocuCheck Local gives you a first assessment from a small AI — it is not legal advice. For important contracts and deadlines, please talk to a lawyer or an advice center. Small models can make mistakes — always double-check important statements in the original text.",
    "err.prefix": "Error:",
    "err.webgpu": "WebGPU is not supported. Please reload the page and use a current Chrome/Edge browser.",
    "err.tesseract": "Text recognition (Tesseract) could not be started. Please reload the page.",
    "err.memory": "Not enough memory. Please choose a smaller document or close other tabs.",
    "err.reload": "Please reload the page and try again. If the issue persists, use a current desktop browser with WebGPU support.",
    "safety.localOnly": "All processing runs locally — no data leaves your device.",
    "safety.devtools": "Check it yourself: open DevTools (F12 → Network) during analysis.",
    ...
    "note.transCut": "(Note: very long document — the first {n} characters were translated.)",
    "trans.same": "The document already appears to be in {ziel} — nothing to translate.",
    "trans.loading": "Loading translation model (one-time download, works offline afterwards) …",
    "trans.running": "Translating section {i}/{n} …",

    "step.ready": "✓ ready",
    "hint.needModel": "Your document is ready ✓ — translation works right away. For summary & analysis, load the AI model in step 1.",
    ...
    "footer": "DocuCheck Local v0.3 · Tech: WebLLM 0.2.79 (MLC AI, Apache 2.0) + WebGPU · transformers.js 3.8.1 + OPUS-MT (translation, CPU) · Tesseract.js 5.1.1 (OCR) + pdf.js 4.4.168 — all libraries bundled locally, no CDN calls. Part of the Edge Cognitive AI Platform.",
    ...
    "prompt.sysVertrag": "You are a contract reviewer for German consumer contracts. You do not replace legal advice, but you should highlight risks, costs, deadlines, and termination conditions in a structured way. Analyze the following contract text and provide the answer in four sections:\n\nSummary (max 10 sentences)\nDeadlines (list with date and event)\nCosts & Fees (list with amount and condition)\nTermination & Renewal (description of minimum term, notice period, and automatic renewal).\n\nIf text passages are unclear or contain OCR errors, mark them with \"UNCLEAR\" and do not invent anything.",
  ...
  /* ================= TIẾNG VIỆT ================= */
  vi: {
    "html.title": "DocuCheck Local — Phân tích tài liệu bằng AI, không cần đám mây",
    ...
    "s1.presetLabel": "Hồ sơ:",
    "s1.p1": "Nhanh & nhẹ (1B)",
    "s1.p2": "Chuẩn (1B)",
    "s1.p3": "Chính xác & kỹ lưỡng (3B)",
    "s1.p4": "Thử nghiệm (Phi-3.5-mini)",
    "s1.m0": "Qwen2 0.5B — rất nhẹ, cho thiết bị yếu (~0,5 GB)",
    ...
    "s1.m4": "Phi 3.5 mini — thử nghiệm, kỹ lưỡng (~2,2 GB)",
    ...
    "s1.autoLoad": "Mô hình đã có trên thiết bị — đang tự động mở …",
    "s1.ready": "Mô hình sẵn sàng — bộ đếm mạng bắt đầu hoạt động từ bây giờ.",
    "s1.error": "Lỗi khi tải:",
    "s1.needModel": "Vui lòng tải xong mô hình ở Bước 1 trước.",
    "s1.needModelTitle": "Thiếu mô hình",
    "s1.offline": "Vui lòng tải lại trang và thử lại. Nếu lỗi vẫn xảy ra, hãy dùng trình duyệt máy tính mới hỗ trợ WebGPU.",
    "s1.ocrHint": "OCR vẫn chạy được cục bộ mà không cần WebGPU.",

    "s2.tag": "Bước 2",
    "s2.title": "Chọn tài liệu",
    "s2.ready": "Tài liệu sẵn sàng",
    "s2.needDoc": "Vui lòng chọn và đọc tài liệu ở Bước 2 trước.",
    "s2.needDocTitle": "Thiếu tài liệu",
    "s2.error": "Không xử lý được tài liệu. Vui lòng chọn tài liệu rõ ràng hoặc PDF có chữ.",
    "s2.ocrBad": "Nhận dạng chữ chưa đầy đủ. Vui lòng dùng ảnh hoặc bản scan rõ hơn với độ phân giải cao hơn.",
    "s2.fileTooBig": "File quá lớn. Vui lòng chọn tài liệu nhỏ hơn.",
    ...
    "ocr.error": "Lỗi OCR:",
    "ocr.badQuality": "Nhận dạng chữ chưa đầy đủ. Vui lòng dùng ảnh hoặc bản scan rõ hơn với độ phân giải cao hơn.",
    "ocr.workerFailed": "Tesseract-Worker bị lỗi. Vui lòng tải lại trang.",
    "file.reading": "Đang đọc:",
    "file.error": "Không đọc được file:",
    "file.tooBig": "File quá lớn. Vui lòng chọn tài liệu nhỏ hơn.",
    "file.chars": "ký tự",
    ...
    "s3.presetLabel": "Kiểm tra:",
    "s3.presetNone": "-- chọn --",
    "s3.p1": "Kiểm tra toàn diện (hợp đồng)",
    "s3.p2": "Hợp đồng thuê nhà (tư nhân)",
    "s3.p3": "Hợp đồng di động",
    "s3.p4": "Điều khoản bảo hiểm",
    "s3.presetRun": "Bắt đầu",
    "btn.sum": "Tóm tắt",
    ...
    "disclaimer": "Lưu ý: DocuCheck Local chỉ đưa ra đánh giá ban đầu từ một mô hình AI nhỏ — đây không phải tư vấn pháp lý. Với hợp đồng và thời hạn quan trọng, hãy hỏi luật sư hoặc trung tâm tư vấn. Mô hình nhỏ có thể sai — luôn kiểm tra lại các thông tin quan trọng trong văn bản gốc.",
    "err.prefix": "Lỗi:",
    "err.webgpu": "WebGPU không được hỗ trợ. Vui lòng tải lại trang và dùng trình duyệt Chrome/Edge mới.",
    "err.tesseract": "Không khởi động được nhận dạng chữ (Tesseract). Vui lòng tải lại trang.",
    "err.memory": "Không đủ bộ nhớ. Vui lòng chọn tài liệu nhỏ hơn hoặc đóng các tab khác.",
    "err.reload": "Vui lòng tải lại trang và thử lại. Nếu lỗi vẫn xảy ra, hãy dùng trình duyệt máy tính mới hỗ trợ WebGPU.",
    "safety.localOnly": "Mọi xử lý đều chạy cục bộ — không gửi dữ liệu ra ngoài thiết bị.",
    "safety.devtools": "Tự kiểm tra: mở DevTools (F12 → Network) trong lúc phân tích.",
    ...
    "note.transCut": "(Lưu ý: tài liệu rất dài — chỉ dịch {n} ký tự đầu tiên.)",
    "trans.same": "Tài liệu có vẻ đã ở {ziel} — không có gì để dịch.",
    "trans.loading": "Đang tải mô hình dịch (chỉ một lần, sau đó dùng ngoại tuyến) …",
    "trans.running": "Đang dịch phần {i}/{n} …",

    "step.ready": "✓ sẵn sàng",
    "hint.needModel": "Tài liệu đã sẵn sàng ✓ — có thể dịch ngay. Để tóm tắt & phân tích, hãy tải mô hình AI ở Bước 1.",
    ...
    "footer": "DocuCheck Local v0.3 · Công nghệ: WebLLM 0.2.79 (MLC AI, Apache 2.0) + WebGPU · transformers.js 3.8.1 + OPUS-MT (dịch, CPU) · Tesseract.js 5.1.1 (OCR) + pdf.js 4.4.168 — mọi thư viện được đóng gói cục bộ, không gọi CDN. Thuộc Edge Cognitive AI Platform.",
    ...
    "prompt.sysVertrag": "Bạn là một trợ lý kiểm tra hợp đồng dành cho người tiêu dùng tại Đức. Bạn không thay thế luật sư, nhưng cần chỉ ra rủi ro, chi phí, thời hạn và điều kiện chấm dứt hợp đồng một cách rõ ràng. Phân tích văn bản hợp đồng sau và trả lời theo 4 phần:\n\nTóm tắt (tối đa 10 câu)\nThời hạn & mốc thời gian (danh sách ngày và sự kiện)\nChi phí & phí (danh sách số tiền và điều kiện áp dụng)\nChấm dứt & gia hạn (mô tả thời hạn tối thiểu, thời gian báo hủy và việc gia hạn tự động).\n\nNếu có đoạn văn không rõ hoặc sai do OCR, hãy ghi „KHÔNG RÕ“ và không được tự bịa thêm.",
